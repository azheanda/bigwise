 ...
 * method:
 */
public class DayDataSpider {

	/*
	 * Back Up Data
	 */
	public static void GetDayData(String date,String url)
	{
		DayDataSpider test = new DayDataSpider();
		try {
	...
	public void extractor(String urlString) throws IOException {
		...
		try {
			// 获得网页文本内容
			String str = DayDataSpider.getDocumnetAt(urlString);
			// 创建提取股票数据来源的正则表达式
